...
function listVipFeature(){
	...
	while($i <= 20){
		if($lang['vip_custom_feature' . $i] != ''){
			$list .= boomAddonsTemplate('../addons/vip/system/template/vip_feature', $lang['vip_custom_feature' . $i]);
		}
		$i++;
	}
	return $list;
	...
	<div id="vippart2" class="vippart hidden">
		...
		<div class="hpad15 bpad15">
			<div class="vip_table_list text_small bpad10">
				<?php echo boomAddonsTemplate('../addons/vip/system/template/vip_pricing',1); ?>
				<?php echo boomAddonsTemplate('../addons/vip/system/template/vip_pricing',2); ?>
				<?php echo boomAddonsTemplate('../addons/vip/system/template/vip_pricing',3); ?>
				<?php echo boomAddonsTemplate('../addons/vip/system/template/vip_pricing',4); ?>
				<?php echo boomAddonsTemplate('../addons/vip/system/template/vip_pricing',5); ?>
			</div>
		</div>
