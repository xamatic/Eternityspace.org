...
<div id="global_chat" class="backglob chatheight" >
	<div id="chat_room_dock" class="chat_room_dock bsidebar">
		<div class="chat_room_dock_panel back_panel">
			<div class="chat_room_dock_controls">
				<div class="vpad5">
					<div class="rtl_elem">
						<?php if(canRoom()){ ?>
	...
	<div id="left_menu" class="pheight bleftpan fhide">
		<div id="left_menu_content" class="bsidebar">
			...
			<div id="extensions_menu_btn" title="Extensions" class="bhover left_menu_item menutrig" onclick="if(typeof getExtensions === 'function'){ getExtensions(); }">
				<div class="left_menu_icon">
					<i class="fa fa-puzzle-piece leftmenui"></i>
				</div>
			</div>
			<div id="discord_menu_btn" title="Discord" class="bhover left_menu_item menutrig" onclick="getDiscord();">
				<div class="left_menu_icon">
					<svg class="discord_svg_icon" viewBox="0 -28.5 256 256" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
			...
			<div id="public_theme_menu_btn" title="Public Themes" class="bhover left_menu_item menutrig" onclick="getPublicThemeLeft();">
				<div class="left_menu_icon">
					<i class="fa fa-brush leftmenui"></i>
				</div>
			</div>
			<div id="super_vip_menu_btn" title="Star VIP" class="bhover left_menu_item menutrig" onclick="if(typeof openVip === 'function'){ openVip('star'); }">
				<div class="left_menu_icon">
					<i class="fa fa-gem leftmenui"></i>
				</div>
			</div>
		</div>
	</div>
			...
			<div id="wrap_chat">
				...
				<div id="top_chat_container" class="back_input input_wrap">
					<div id="container_input" class="no_rtl hidden">
						...
						<div id="slash_command_menu" class="slash_command_menu back_box bshadow">
...
<script data-cfasync="false">
	...
	var userAction = <?php echo json_encode($data['user_action']); ?>;
	var	globNotify = 0;
	var pCount = <?php echo json_encode($data['pcount']); ?>;
	var uCall = <?php echo json_encode($data['ucall']); ?>;
